...
public class PurchaseController {
    ...
    /**
     * 进货，新增进货记录
     * @param purchaseRecordDTO 进货记录
     * @return 提示消息
     */
    @PostMapping(value = "/addPurchase", consumes = MediaType.APPLICATION_JSON_VALUE)
    public ResultDTO addPurchaseRecord(@RequestBody PurchaseRecordDTO purchaseRecordDTO) {
        return purService.purchase(purchaseRecordDTO);
    }
    ...
    public ResultDTO getPurRecordsByPage(HttpServletRequest request) {
